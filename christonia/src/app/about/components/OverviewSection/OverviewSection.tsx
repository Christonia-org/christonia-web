...
export default async function OverviewSection() {
  ...
  const { count: contributorCountResult, error: contributorError } =
    await supabase
      .from("CONTRIBUTOR")
      .select("*", { count: "exact", head: true });
  ...
  if (contributorError) {
    console.error(
      "Error fetching contributor count:",
      contributorError.message
    );
  } else {
    contributorCount = contributorCountResult!;
  }
      ...
      <div className={styles.overviewGrid}>
        ...
        <div className={styles.originBlock}>
          ...
          <p>
            ...
            apologists by the likes of David Wood, Sam Shamoun, and Godlogic.
        ...
        <div className={styles.openSourceBlock}>
          <h3>
            <img
              ...
              className={styles.openSourceIcon}
            />
            Collaborative Work
          </h3>
          <p>
            ...
            submitting a request. This also extends to the curriculum itself.
            Anyone can work on new lessons, add new resources and improve
            existing lessons, so long as they join the team.
          </p>
          <p>
