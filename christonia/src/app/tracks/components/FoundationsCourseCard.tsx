      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex items-center gap-5 self-start md:self-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {isSelected && (
              <span className="bg-brand-teal text-white text-[10px] md:text-xs font-bold px-2 py-1 rounded uppercase tracking-wider">
                Selected
              </span>
            )}
          </div>
        ...
        <div className="flex gap-4 w-full md:w-auto">
          {isSelected ? (
            <Link
              href={link}
              className="flex-1 md:flex-none text-center bg-brand-teal hover:bg-brand-teal-dark text-white px-10 py-3 rounded-md font-semibold text-lg transition-colors"
            >
              Open
            </Link>
          ) : (
            <>
              <button
                className="flex-1 md:flex-none bg-brand-teal hover:bg-brand-teal-dark text-white px-10 py-3 rounded-md font-semibold text-lg transition-colors"
                onClick={() => onSelect(id)}
              >
                Select
              </button>
              <Link
                href={link}
                className="flex-1 md:flex-none text-center bg-transparent border border-gray-500 hover:bg-[#34495e] text-white px-10 py-3 rounded-md font-semibold text-lg transition-colors"
              >
                View
              </Link>
            </>
