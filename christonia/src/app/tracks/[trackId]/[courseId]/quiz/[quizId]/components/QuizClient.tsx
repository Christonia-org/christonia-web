      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col gap-2 md:gap-3">
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight leading-tight">
            {resultData ? `${quiz.title} Results` : quiz.title}
          </h1>
              ...
              <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col items-center w-full">
                <div className="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-4 md:gap-6 w-full max-w-3xl">
                  ...
                  <button
                    ...
                    className={`flex-grow md:flex-initial md:min-w-[240px] flex items-center justify-center gap-2 px-10 py-3 rounded-lg font-bold transition-all shadow-lg text-base bg-brand-teal text-white shadow-brand-teal/20 hover:scale-[1.02] ${
              ...
              <div className="space-y-8">
                {quiz.questions.map((q: any, index: number) => (
                  <QuizResultCard
                    ...
                    index={index}
                    question={q}
                    correction={resultData.correction.find(
