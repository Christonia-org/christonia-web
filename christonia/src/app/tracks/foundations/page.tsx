...
import { getCourseById, getFoundationsCourse } from "@/lib/mock/courses";
import ModuleComponent from "../[trackId]/[courseId]/components/ModuleComponent";
import SupportUsSection from "@/components/SupportUsSection";

export default function FoundationsCoursePage() {
  const course = getFoundationsCourse();
