...
export default function FaqPage() {
  return (
    <>
      <div className="flex flex-col items-center gap-8 bg-background">
        <div className="w-full">
          <FaqSection />
        </div>

        <section className="flex flex-col justify-center items-center text-center py-16 px-6 gap-6 bg-background w-full">
