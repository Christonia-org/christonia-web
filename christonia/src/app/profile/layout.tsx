...
export default function ProfileLayout({
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-64px)] text-white px-4 md:px-24 py-8 md:py-12 gap-6 items-start font-sans">
      <aside className="w-full md:w-[300px] lg:w-[350px] shrink-0 py-4 md:py-6">
        <nav className="px-0 md:px-4">
          <ul className="flex flex-wrap md:flex-col gap-2 justify-center md:justify-start">
      ...
      <main className="flex-grow w-full bg-white/5 md:bg-transparent rounded-xl p-6 md:p-8">
        {children}
      </main>
    </div>
  );
